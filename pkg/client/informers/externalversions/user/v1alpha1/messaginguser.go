...
import (
	...
	v1alpha1 "github.com/enmasseproject/enmasse/pkg/client/listers/user/v1alpha1"
...
type MessagingUserInformer interface {
	...
	Lister() v1alpha1.MessagingUserLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.UserV1alpha1().MessagingUsers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UserV1alpha1().MessagingUsers(namespace).Watch(options)
			},
		},
		&userv1alpha1.MessagingUser{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *messagingUserInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&userv1alpha1.MessagingUser{}, f.defaultInformer)
}

func (f *messagingUserInformer) Lister() v1alpha1.MessagingUserLister {
	return v1alpha1.NewMessagingUserLister(f.Informer().GetIndexer())
}
