...
type MessagingUserInterface interface {
	Create(*v1alpha1.MessagingUser) (*v1alpha1.MessagingUser, error)
	Update(*v1alpha1.MessagingUser) (*v1alpha1.MessagingUser, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MessagingUser, error)
	List(opts v1.ListOptions) (*v1alpha1.MessagingUserList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MessagingUser, err error)
...
func newMessagingUsers(c *UserV1alpha1Client, namespace string) *messagingUsers {
...
func (c *messagingUsers) Get(name string, options v1.GetOptions) (result *v1alpha1.MessagingUser, err error) {
	result = &v1alpha1.MessagingUser{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *messagingUsers) List(opts v1.ListOptions) (result *v1alpha1.MessagingUserList, err error) {
	result = &v1alpha1.MessagingUserList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("messagingusers").
...
func (c *messagingUsers) Create(messagingUser *v1alpha1.MessagingUser) (result *v1alpha1.MessagingUser, err error) {
	result = &v1alpha1.MessagingUser{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("messagingusers").
...
func (c *messagingUsers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MessagingUser, err error) {
	result = &v1alpha1.MessagingUser{}
