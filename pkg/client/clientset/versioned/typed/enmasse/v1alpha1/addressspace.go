...
type AddressSpaceInterface interface {
	Create(*v1alpha1.AddressSpace) (*v1alpha1.AddressSpace, error)
	Update(*v1alpha1.AddressSpace) (*v1alpha1.AddressSpace, error)
	UpdateStatus(*v1alpha1.AddressSpace) (*v1alpha1.AddressSpace, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.AddressSpace, error)
	List(opts v1.ListOptions) (*v1alpha1.AddressSpaceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AddressSpace, err error)
...
func newAddressSpaces(c *EnmasseV1alpha1Client, namespace string) *addressSpaces {
...
func (c *addressSpaces) Get(name string, options v1.GetOptions) (result *v1alpha1.AddressSpace, err error) {
	result = &v1alpha1.AddressSpace{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *addressSpaces) List(opts v1.ListOptions) (result *v1alpha1.AddressSpaceList, err error) {
	result = &v1alpha1.AddressSpaceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("addressspaces").
...
func (c *addressSpaces) Create(addressSpace *v1alpha1.AddressSpace) (result *v1alpha1.AddressSpace, err error) {
	result = &v1alpha1.AddressSpace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("addressspaces").
...
func (c *addressSpaces) Update(addressSpace *v1alpha1.AddressSpace) (result *v1alpha1.AddressSpace, err error) {
	result = &v1alpha1.AddressSpace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addressspaces").
...
func (c *addressSpaces) UpdateStatus(addressSpace *v1alpha1.AddressSpace) (result *v1alpha1.AddressSpace, err error) {
	result = &v1alpha1.AddressSpace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addressspaces").
...
func (c *addressSpaces) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AddressSpace, err error) {
	result = &v1alpha1.AddressSpace{}
